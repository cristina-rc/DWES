...
/*
 * EJEMPLO DE ACCESO A CONCURRENTE A UNA MISMA CONEXIÃ“N
 * MÃ¡s eficiente pero el acceso debe ser sincronizado
 * Se establece la conexiÃ³n con el mÃ©todo init usando todos
 * los hilos la misma conexiÃ³n
 */
	...
	public void init(ServletConfig config) {
		try {
			...
			conexion = DriverManager.getConnection(
					"jdbc:mysql://localhost/tiendalibros", "root", "");
