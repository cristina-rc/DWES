...
/*
 * EJEMPLO BÃ�SICO DE CONSULTA A UNA BASE DE DATOS 
 * Cada hilo o peticiÃ³n crea su propia conexiÃ³n y sentencia 
 * 
 */
...
public class ConsultaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// Paso 4: Ejecutar las sentencias SQL a trav Ì�s de los objetos Statement
