...
//FALTA REVISAR LA SESIÓN DE NOMBRE (SE QUEDA GRABADA) y aumentar la cantidad de las frutas

session_start();

// Obtengo el valor de la sesión
...
//recorrer el array y asignar valores cantidad y fruta para sumarlo a cantidad abajo
}

// Cambio el valor de la sesión con la lista de la compra
  ...
  <?php
    ...
    <?php
        ...
        if(isset($arrayFrutas)){
          ...
          //Pintar el array de frutas con un recuadro
